...
if __name__ == "__main__":
    ...
    base_params = {
        ...
        "parameters_ICE":{
            ...
            "delta_z":0.05,
            "transportType": 2,
            "min_max_Quality": [500,1000],
            "min_max_Efficiency": [100,500],
            "min_max_Cost": [0.1,2],
        },
        "parameters_EV":{
            "landscape_seed": 13,
            ...
            "transportType": 3,
            "min_max_Quality": [500,1000],
            "min_max_Efficiency": [100,2000],
            "min_max_Cost": [0.1,2],
        },
        "parameters_urban_public_transport":{
            "attributes": [50,11,30],#EFF cant be 1 for some some reason, honestly not sure why 
            "price": 0.1,
            "id": -1, 
            "firm" : -1, 
            "transportType" : 0,
        ...
        "parameters_social_network":{
            ...
            "prob_rewire": 0.1,
            "a_environment": 1,#easy ev adoption 
            "b_environment": 1,
            "a_innovativeness": 1,#easy ev adoption(low)
            "b_innovativeness": 1,
            "a_price": 1,#most people price sensitive
            "b_price": 1,
