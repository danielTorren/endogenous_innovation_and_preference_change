...
def distance_ev_prop_age_price_emissions_parallel_run(
    ...
    distance_list, ev_prop_list, age_list, price_list, emissions_list, efficiency_list = zip(
        *res
    )
    return np.asarray(distance_list), np.asarray(ev_prop_list), np.asarray(age_list) , np.asarray(price_list) , np.asarray(emissions_list) , np.asarray(efficiency_list)
