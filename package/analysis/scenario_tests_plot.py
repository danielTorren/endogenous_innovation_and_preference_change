...
def plot_policy_results_ev(base_params, fileName, outputs, x_label, y_label, prop_name, dpi=300):
...
def plot_policy_results(base_params,fileName,  outputs,  x_label, y_label, prop_name, dpi=300):
...
def plot_policy_results_cum(base_params,fileName,  outputs,  x_label, y_label, prop_name, dpi=300):
