...
class Firm:
    ...
    def calc_optimal_price_cars(self, car_list, car_data):
        ...
        #quit()
        print("Priceing and em", term1[0])
        print("Quality term",term2[0])
        ...
        print("fuel costs and emissions term",term4[0])
        ...
        print("beta vlaues term",self.beta_s_values[0])
        #quit()
